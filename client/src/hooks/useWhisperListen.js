...
export function useWhisperListen({ onTranscript, onError, silenceMs = 1100, minSpeechMs = 300 } = {}) {
  ...
  const cycle = useCallback(() => {
    ...
    const tick = () => {
      ...
      const hardCap = now - started > 15000;
    ...
    rafRef.current = requestAnimationFrame(tick);
  }, [onTranscript, onError, silenceMs, minSpeechMs]);
